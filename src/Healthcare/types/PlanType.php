...
class PlanType
{
    ...
    /**
     * @property \Healthcare\types\AmountDeductibleType
    ...
    /**
     * @property \Healthcare\types\AmountDeductibleType $familyAnnualOOPLimitAmount
     */
     ...
     *
     * @return \Healthcare\types\AmountDeductibleType
     */
     ...
     *
     * @param \Healthcare\types\AmountDeductibleType $familyAnnualDeductibleAmount
     * @return self
     */
    public function setFamilyAnnualDeductibleAmount(\Healthcare\types\AmountDeductibleType $familyAnnualDeductibleAmount)
    {
     ...
     *
     * @param \Healthcare\types\AmountDeductibleType
     * $individualAnnualDeductibleAmount
     * @return self
     */
    public function setIndividualAnnualDeductibleAmount(\Healthcare\types\AmountDeductibleType $individualAnnualDeductibleAmount)
    {
     ...
     *
     * @param \Healthcare\types\AmountDeductibleType $familyAnnualOOPLimitAmount
     * @return self
     */
    public function setFamilyAnnualOOPLimitAmount(\Healthcare\types\AmountDeductibleType $familyAnnualOOPLimitAmount)
    {
     ...
     *
     * @param \Healthcare\types\AmountDeductibleType $individualAnnualOOPLimitAmount
     * @return self
     */
    public function setIndividualAnnualOOPLimitAmount(\Healthcare\types\AmountDeductibleType $individualAnnualOOPLimitAmount)
    {
